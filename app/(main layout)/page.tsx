...
export default async function Home() {
    ...
    return (
        <main className="flex flex-col">
            ...
            <div id="whatis-section" className="flex flex-row align-center justify-around p-[1em] bg-cyan-300 border-[2em] border-image-[url('/borders/MetalScrewBorder.png')] border-slice-[990] border-image-width-[150px] border-repeat-round">
