    ...
    return (
        <main className="flex flex-col">
            <div id="top-banner" className="flex flex-row justify-center align-center p-[2em] bg-[url('/images/backgrounds/SpaceBannerSTATIC.png')]">
                <Image
                    className="sm:h-[20em] w-auto"
                    src={SoulboundTextLogo}
                    alt="Space banner image"
                    priority
                />
            </div>
            <div id="whatis-section" className="flex flex-col sm:flex-row align-center justify-around p-[1em] bg-cyan-300 border-[2em] border-image-[url('/images/borders/MetalScrewBorder.png')] border-slice-[990] border-image-width-[150px] border-repeat-round">
                <div id="podcast-description" className="flex flex-col justify-center m-[1em] sm:w-1/3">
                ...
                <Image
                    id="episode-cover"
                    className="h-[20em] w-auto sm:mx-[5em]"
                    src={defaultCover}
                    alt="Soulbound Podcast cover art"
                />
            </div>
            <div id="latestep-section" className="flex flex-col align-center py-[2em] px-[2em] sm:px-[10em] bg-[url('/images/backgrounds/MetalHeartBackground.png')] bg-size-[5em] bg-repeat border-[2em] border-image-[url('/images/borders/MetalHashBorder.png')] border-slice-t-[980] border-slice-r-[1000] border-slice-b-[990] border-slice-l-[1030] border-image-width-[150px] border-repeat-round">
            ...
            <div id="keepingup-section" className="flex flex-col justify-center align-center p-[2em] sm:p-[3em] bg-cyan-300 border-[2em] border-image-[url('/images/borders/MetalScrewBorder.png')] border-slice-[990] border-image-width-[150px] border-repeat-round">
