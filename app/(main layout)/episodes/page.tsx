...
export default function Episodes() {
    ...
    return (
        <main className="flex flex-row justify-center w-full bg-[url('/images/backgrounds/SpaceBannerSTATIC.png')]">
            <div id="center-container" className="flex flex-col w-full md:w-1/2 h-full bg-background border-x-[1rem] border-image-[url('/images/borders/RivetSideBorder.png')] border-slice-[157] border-image-width-[1rem] border-repeat-round">
