...
import ChevronIcon from "@images/icons/chevron-down-icon.svg";
...
export default function Announcement({
    ...
    return (
        <div id="announcement-container" className={`group ${open ? 'open' : 'closed'} py-[1rem] px-[2rem] whitespace-pre-line bg-[#949494] border-[1rem] border-image-[url('/images/borders/MetalHashBorder.png')] border-slice-[48] border-image-width-[1.5rem] border-repeat-round`}>
            <div className="flex flex-row justify-start items-center">
                <h2>Announcement!</h2>
                <button onClick={animateOpenClose} className="mb-[0.5rem] ml-[2rem] cursor-pointer">
                    {open ? "Hide" : "Show"}
                    <Image
